...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-[#0a0a14]/90 backdrop-blur-xl ${scrolled
            ? "border-b border-white/8 shadow-[0_4px_30px_rgba(0,0,0,0.4)]"
            : ""
          }`}
      >
